...
If you want to submit an extension to [extensions.bilup.org](https://github.com/Bilup/extensions/), you need to follow these rules:
...
For more details on submitting extensions, please **contact us** (support@bilup.org).