...
Scratch is broken up into a bunch of different packages, each implementing one part of the app.
 ...
 - **scratch-svg-renderer** helps fix various SVG rendering problems (we rename this to **@bilup/scratch-svg-renderer**)
